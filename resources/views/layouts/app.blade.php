    ...
    @auth
        ...
        <div id="call-overlay" class="hidden fixed inset-0 z-[100] bg-slate-900/95 flex flex-col items-center justify-between p-6 text-white safe-area-bottom">
            ...
            <div class="w-full max-w-md flex justify-center items-center gap-6 mb-12">
                <button type="button" id="decline-call-btn" class="hidden w-14 h-14 bg-red-600 hover:bg-red-700 active:bg-red-800 text-white rounded-full flex items-center justify-center shadow-lg transition transform hover:scale-105 z-20" title="Decline">
                    <svg class="w-7 h-7 rotate-[135deg]" fill="currentColor" viewBox="0 0 24 24"><path d="M6.62 10.79a15.05 15.05 0 006.59 6.59l2.2-2.2a1 1 0 011.01-.24c1.12.37 2.31.57 3.53.57.55 0 1 .45 1 1V20a1 1 0 01-1 1C9.99 21 3 14.01 3 6a1 1 0 011-1h2.62c.55 0 1 .45 1 1 0 1.22.2 2.41.57 3.53a1 1 0 01-.24 1.01l-2.33 2.25z"/></svg>
                </button>

                <button type="button" id="accept-call-btn" class="hidden w-14 h-14 bg-green-600 hover:bg-green-700 active:bg-green-800 text-white rounded-full flex items-center justify-center shadow-lg transition transform hover:scale-105 z-20" title="Accept">
                ...
                <button type="button" id="toggle-mute-btn" class="hidden w-12 h-12 bg-slate-700 hover:bg-slate-600 text-white rounded-full flex items-center justify-center shadow-md transition z-20" title="Mute Audio">
                    <svg class="w-6 h-6" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M19 11a7 7 0 01-7 7m0 0a7 7 0 01-7-7m7 7v4m0 0H8m4 0h4m-4-8a3 3 0 01-3-3V5a3 3 0 116 0v6a3 3 0 01-3 3z"/>
                    </svg>
                </button>

                <button type="button" id="toggle-video-btn" class="hidden w-12 h-12 bg-slate-700 hover:bg-slate-600 text-white rounded-full flex items-center justify-center shadow-md transition z-20" title="Toggle Camera">
                    <svg class="w-6 h-6" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M15 10l4.553-2.276A1 1 0 0121 8.618v6.764a1 1 0 01-1.447.894L15 14M5 18h8a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v8a2 2 0 002 2z"/>
                    </svg>
                </button>

                <button type="button" id="hangup-call-btn" class="hidden w-14 h-14 bg-red-600 hover:bg-red-700 active:bg-red-800 text-white rounded-full flex items-center justify-center shadow-lg transition transform hover:scale-105 z-20" title="End Call">
