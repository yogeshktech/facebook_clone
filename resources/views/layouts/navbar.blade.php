<nav class="fixed top-0 left-0 right-0 z-40 bg-white shadow-sm h-14 flex items-center px-4">
    <div class="max-w-7xl mx-auto w-full flex items-center justify-between gap-4">
        ...
        <div class="flex items-center gap-2">
            ...
            <a href="{{ route('profile.show', auth()->user()) }}" class="flex items-center gap-2 hover:bg-fb-gray rounded-full p-1 pr-3">
